...
public class ItemInit {
    ...
    public static DeferredRegister<Item> ITEMS = new DeferredRegister<>(ForgeRegistries.ITEMS, JustNeeded.MOD_ID);
    ...
    //Wall Items
    public static final RegistryObject<Item> END_STONE_WALL_ITEM = ITEMS.register("end_stone_wall_item", () -> new BlockItemBase(BlockInit.END_STONE_WALL.get()));
    public static final RegistryObject<Item> NETHERRACK_WALL_ITEM = ITEMS.register("netherrack_wall_item", () -> new BlockItemBase(BlockInit.NETHERRACK_WALL.get()));
    public static final RegistryObject<Item> CRACKED_STONE_BRICKS_WALL_ITEM = ITEMS.register("cracked_stone_bricks_wall_item", () -> new BlockItemBase(BlockInit.CRACKED_STONE_BRICKS_WALL.get()));
    public static final RegistryObject<Item> SMOOTH_STONE_WALL_ITEM = ITEMS.register("smooth_stone_wall_item", () -> new BlockItemBase(BlockInit.SMOOTH_STONE_WALL.get()));
    ...
    public static final RegistryObject<Item> END_STONE_STAIRS_ITEM = ITEMS.register("end_stone_stairs_item", () -> new BlockItemBase(BlockInit.END_STONE_STAIRS.get()));
    public static final RegistryObject<Item> NETHERRACK_STAIRS_ITEM = ITEMS.register("netherrack_stairs_item", () -> new BlockItemBase(BlockInit.NETHERRACK_STAIRS.get()));
    public static final RegistryObject<Item> SMOOTH_STONE_STAIRS_ITEM = ITEMS.register("smooth_stone_stairs_item", () -> new BlockItemBase(BlockInit.SMOOTH_STONE_STAIRS.get()));
    public static final RegistryObject<Item> CRACKED_STONE_BRICKS_STAIRS_ITEM = ITEMS.register("cracked_stone_bricks_stairs_item", () -> new BlockItemBase(BlockInit.CRACKED_STONE_BRICKS_STAIRS.get()));
    ...
    public static final RegistryObject<Item> END_STONE_SLAB_ITEM = ITEMS.register("end_stone_slab_item", () -> new BlockItemBase(BlockInit.END_STONE_SLAB.get()));
    public static final RegistryObject<Item> NETHERRACK_SLAB_ITEM = ITEMS.register("netherrack_slab_item", () -> new BlockItemBase(BlockInit.NETHERRACK_SLAB.get()));
    public static final RegistryObject<Item> CRACKED_STONE_BRICKS_SLAB_ITEM = ITEMS.register("cracked_stone_bricks_slab_item", () -> new BlockItemBase(BlockInit.CRACKED_STONE_BRICKS_SLAB.get()));
